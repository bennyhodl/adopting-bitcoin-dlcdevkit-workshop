...
const ModalDialog = () => {
  ...
  const { contract, balance, getBalance } = useDlcDevKit()
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md overflow-auto">
        ...
        <div className='flex flex-col'>
          ...
          <Button onClick={async () => await getBalance()} className='bg-black text-white hover:bg-gray-400 my-4'>Sync Wallet</Button>
